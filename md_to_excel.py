...
def process_directory(file_path, output_excel):
    all_entries = []
...
if __name__ == "__main__":
    file_path = Path(r"D:\hugh\code\sailwind3.0_docs\docs\lpcreator\guide")
    output_file = Path(__file__).parent / "lpcreator_guide.xlsx"

    process_directory(file_path, output_file)
